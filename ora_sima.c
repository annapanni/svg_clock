...
void drawCircle(double cx, double cy, double r, char* stroke, char* fill, double stroke_width){
  fprintf(img, "<circle cx=\"%lf\" cy=\"%lf\" r=\"%lf\" stroke=\"%s\" fill=\"%s\" stroke-width=\"%lf\" />\n",
    cx + width/2, cy + height/2, r, stroke, fill, stroke_width);
}
...
void drawClock(int hour, int minute, int second){
  ...
  //draw background
  drawCircle(0, 0, rad1, black, beige, 6);
  drawCircle(0, 0, rad1-(rad1-rad2)/2,  "#ebdeab", beige, rad1-rad2);
  drawCircle(0, 0, rad2, black, beige, 0.5);
  drawCircle(0, 0, rad3, black, beige, 0.5);
  drawCircle(0, 0, rad4, black, beige, 0.3);
  drawCircle(0, 0, rad4-1, "#ebdeab", beige, 2);
  drawCircle(0, 0, rad4-2, black, beige, 0.3);
